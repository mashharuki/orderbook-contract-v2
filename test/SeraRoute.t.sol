...
contract SeraRouteTest is TestHelper {
    ...
    function test_matchOrdersRouted_SingleLeg() public {
        ...
        Order memory takerOrder = Order({user: taker, fromToken: address(usdc), toToken: address(eth), fromAmount: 1000 ether, toAmount: 10 ether, initialDepositAmount: 0, feeBps: 0, recipient: taker, expiration: uint48(block.timestamp + 1 days), uuid: 1, routeHash: bytes32(0)});

        Order memory makerOrder = Order({user: maker1, fromToken: address(eth), toToken: address(usdc), fromAmount: 10 ether, toAmount: 1000 ether, initialDepositAmount: 0, feeBps: 0, recipient: maker1, expiration: uint48(block.timestamp + 1 days), uuid: 2, routeHash: bytes32(0)});
    ...
    function test_executeRoute_MixedFunds() public {
        ...
        Order memory takerOrder = Order({user: taker, fromToken: address(usdc), toToken: address(eth), fromAmount: 1000 ether, toAmount: 10 ether, initialDepositAmount: 600 ether, feeBps: 0, recipient: taker, expiration: uint48(block.timestamp + 1 days), uuid: 1, routeHash: bytes32(0)});
    ...
    function test_swapRouted_SingleLeg() public {
        ...
        Order memory takerOrder = Order({user: taker, fromToken: address(usdc), toToken: address(eth), fromAmount: 1000 ether, toAmount: 10 ether, initialDepositAmount: 1000 ether, feeBps: 0, recipient: taker, expiration: uint48(block.timestamp + 1 days), uuid: 3, routeHash: bytes32(0)});

        Order memory makerOrder = Order({user: maker1, fromToken: address(eth), toToken: address(usdc), fromAmount: 10 ether, toAmount: 1000 ether, initialDepositAmount: 0, feeBps: 0, recipient: maker1, expiration: uint48(block.timestamp + 1 days), uuid: 4, routeHash: bytes32(0)});
    ...
    function test_matchOrdersRouted_TwoLegHop() public {
        ...
        Order memory takerLeg1 = Order({user: taker, fromToken: address(usdc), toToken: address(eth), fromAmount: 1000 ether, toAmount: 10 ether, initialDepositAmount: 0, feeBps: 0, recipient: address(sera), expiration: uint48(block.timestamp + 1 days), uuid: 3, routeHash: bytes32(0)});
        Order memory makerLeg1 = Order({user: maker1, fromToken: address(eth), toToken: address(usdc), fromAmount: 10 ether, toAmount: 1000 ether, initialDepositAmount: 0, feeBps: 0, recipient: maker1, expiration: uint48(block.timestamp + 1 days), uuid: 4, routeHash: bytes32(0)});

        // Leg 2: ETH→BTC (final, pay out to taker)
        Order memory takerLeg2 = Order({user: taker, fromToken: address(eth), toToken: address(btc), fromAmount: 10 ether, toAmount: 1 ether, initialDepositAmount: 0, feeBps: 0, recipient: taker, expiration: uint48(block.timestamp + 1 days), uuid: 5, routeHash: bytes32(0)});
        Order memory makerLeg2 = Order({user: maker2, fromToken: address(btc), toToken: address(eth), fromAmount: 1 ether, toAmount: 10 ether, initialDepositAmount: 0, feeBps: 0, recipient: maker2, expiration: uint48(block.timestamp + 1 days), uuid: 6, routeHash: bytes32(0)});
    ...
    function test_matchOrdersRouted_WithFees() public {
        ...
        Order memory takerOrder = Order({user: taker, fromToken: address(usdc), toToken: address(eth), fromAmount: 1000 ether, toAmount: 10 ether, initialDepositAmount: 0, feeBps: 1000, recipient: taker, expiration: uint48(block.timestamp + 1 days), uuid: 7, routeHash: bytes32(0)});
        Order memory makerOrder = Order({user: maker1, fromToken: address(eth), toToken: address(usdc), fromAmount: 10 ether, toAmount: 1000 ether, initialDepositAmount: 0, feeBps: 1000, recipient: maker1, expiration: uint48(block.timestamp + 1 days), uuid: 8, routeHash: bytes32(0)});
    ...
    function test_matchOrdersRouted_ComplexMultilegWithFees() public {
        ...
        Order memory makerLeg1 = Order({user: maker1, fromToken: address(eth), toToken: address(usdc), fromAmount: 2 ether, toAmount: 2000 ether, initialDepositAmount: 0, feeBps: 0, recipient: maker1, expiration: uint48(block.timestamp + 1 days), uuid: 71, routeHash: bytes32(0)});

        // Leg 2: Taker 3000 USDC -> Maker 2 for 3 BTC
        // Taker defines 0% fee on this intermediate hop
        Order memory takerLeg2 = Order({user: taker, fromToken: address(usdc), toToken: address(btc), fromAmount: 3000 ether, toAmount: 3 ether, initialDepositAmount: 0, feeBps: 0, recipient: address(sera), expiration: uint48(block.timestamp + 1 days), uuid: 72, routeHash: bytes32(0)});
        Order memory makerLeg2 = Order({user: maker2, fromToken: address(btc), toToken: address(usdc), fromAmount: 3 ether, toAmount: 3000 ether, initialDepositAmount: 0, feeBps: 0, recipient: maker2, expiration: uint48(block.timestamp + 1 days), uuid: 73, routeHash: bytes32(0)});
    ...
    function test_matchOrdersRouted_SplitAndMultileg() public {
        ...
        // Leg 1: 100 USDC → 1 ETH (direct, final output)
        Order memory takerLeg1 = Order({user: taker, fromToken: address(usdc), toToken: address(eth), fromAmount: 100 ether, toAmount: 1 ether, initialDepositAmount: 0, feeBps: 0, recipient: taker, expiration: uint48(block.timestamp + 1 days), uuid: 9, routeHash: bytes32(0)});
        Order memory makerLeg1 = Order({user: maker1, fromToken: address(eth), toToken: address(usdc), fromAmount: 1 ether, toAmount: 100 ether, initialDepositAmount: 0, feeBps: 0, recipient: maker1, expiration: uint48(block.timestamp + 1 days), uuid: 10, routeHash: bytes32(0)});

        // Leg 2: 900 USDC → 0.9 BTC (intermediate, hold in Sera)
        Order memory takerLeg2 = Order({user: taker, fromToken: address(usdc), toToken: address(btc), fromAmount: 900 ether, toAmount: 0.9 ether, initialDepositAmount: 0, feeBps: 0, recipient: address(sera), expiration: uint48(block.timestamp + 1 days), uuid: 11, routeHash: bytes32(0)});
        Order memory makerLeg2 = Order({user: maker2, fromToken: address(btc), toToken: address(usdc), fromAmount: 0.9 ether, toAmount: 900 ether, initialDepositAmount: 0, feeBps: 0, recipient: maker2, expiration: uint48(block.timestamp + 1 days), uuid: 12, routeHash: bytes32(0)});

        // Leg 3: 0.9 BTC → 9 ETH (final, pay out to taker)
        Order memory takerLeg3 = Order({user: taker, fromToken: address(btc), toToken: address(eth), fromAmount: 0.9 ether, toAmount: 9 ether, initialDepositAmount: 0, feeBps: 0, recipient: taker, expiration: uint48(block.timestamp + 1 days), uuid: 13, routeHash: bytes32(0)});
        Order memory makerLeg3 = Order({user: maker3, fromToken: address(eth), toToken: address(btc), fromAmount: 9 ether, toAmount: 0.9 ether, initialDepositAmount: 0, feeBps: 0, recipient: maker3, expiration: uint48(block.timestamp + 1 days), uuid: 14, routeHash: bytes32(0)});
    ...
    function test_matchOrdersRouted_SplitMultileg_MakerExpiredReverts() public {
        ...
        Order memory takerLeg1 = Order({user: taker, fromToken: address(usdc), toToken: address(eth), fromAmount: 100 ether, toAmount: 1 ether, initialDepositAmount: 0, feeBps: 0, recipient: taker, expiration: uint48(block.timestamp + 1 days), uuid: 15, routeHash: bytes32(0)});
        Order memory makerLeg1 = Order({user: maker1, fromToken: address(eth), toToken: address(usdc), fromAmount: 1 ether, toAmount: 100 ether, initialDepositAmount: 0, feeBps: 0, recipient: maker1, expiration: uint48(block.timestamp + 1 days), uuid: 16, routeHash: bytes32(0)});
        Order memory takerLeg2 = Order({user: taker, fromToken: address(usdc), toToken: address(btc), fromAmount: 900 ether, toAmount: 0.9 ether, initialDepositAmount: 0, feeBps: 0, recipient: address(sera), expiration: uint48(block.timestamp + 1 days), uuid: 17, routeHash: bytes32(0)});
        Order memory makerLeg2 = Order({user: maker2, fromToken: address(btc), toToken: address(usdc), fromAmount: 0.9 ether, toAmount: 900 ether, initialDepositAmount: 0, feeBps: 0, recipient: maker2, expiration: uint48(block.timestamp + 1 days), uuid: 18, routeHash: bytes32(0)});
        Order memory takerLeg3 = Order({user: taker, fromToken: address(btc), toToken: address(eth), fromAmount: 0.9 ether, toAmount: 9 ether, initialDepositAmount: 0, feeBps: 0, recipient: taker, expiration: uint48(block.timestamp + 1 days), uuid: 19, routeHash: bytes32(0)});
    ...
    function test_matchOrdersRouted_RejectsSubset() public {
        ...
        Order memory takerOrder = Order({user: taker, fromToken: address(usdc), toToken: address(eth), fromAmount: 1000 ether, toAmount: 10 ether, initialDepositAmount: 0, feeBps: 0, recipient: address(sera), expiration: uint48(block.timestamp + 1 days), uuid: 20, routeHash: bytes32(0)});
        Order memory makerOrder = Order({user: maker1, fromToken: address(eth), toToken: address(usdc), fromAmount: 10 ether, toAmount: 1000 ether, initialDepositAmount: 0, feeBps: 0, recipient: maker1, expiration: uint48(block.timestamp + 1 days), uuid: 21, routeHash: bytes32(0)});
    ...
    function test_matchOrdersRouted_RejectsMakerWithRouteHash() public {
        ...
        Order memory takerOrder = Order({user: taker, fromToken: address(usdc), toToken: address(eth), fromAmount: 1000 ether, toAmount: 10 ether, initialDepositAmount: 0, feeBps: 0, recipient: taker, expiration: uint48(block.timestamp + 1 days), uuid: 22, routeHash: bytes32(0)});
    ...
    function test_matchOrdersRouted_RejectsDifferentTakers() public {
        ...
        Order memory takerOrder1 = Order({user: taker, fromToken: address(usdc), toToken: address(eth), fromAmount: 500 ether, toAmount: 5 ether, initialDepositAmount: 0, feeBps: 0, recipient: taker, expiration: uint48(block.timestamp + 1 days), uuid: 24, routeHash: bytes32(0)});
        ...
        Order memory makerOrder1 = Order({user: maker1, fromToken: address(eth), toToken: address(usdc), fromAmount: 5 ether, toAmount: 500 ether, initialDepositAmount: 0, feeBps: 0, recipient: maker1, expiration: uint48(block.timestamp + 1 days), uuid: 26, routeHash: bytes32(0)});
        Order memory makerOrder2 = Order({user: maker2, fromToken: address(eth), toToken: address(usdc), fromAmount: 5 ether, toAmount: 500 ether, initialDepositAmount: 0, feeBps: 0, recipient: maker2, expiration: uint48(block.timestamp + 1 days), uuid: 27, routeHash: bytes32(0)});
    ...
    function test_matchOrders_RejectsRouteBoundOrder() public {
        ...
        Order memory makerOrder = Order({user: maker1, fromToken: address(eth), toToken: address(usdc), fromAmount: 10 ether, toAmount: 1000 ether, initialDepositAmount: 0, feeBps: 0, recipient: maker1, expiration: uint48(block.timestamp + 1 days), uuid: 29, routeHash: bytes32(0)});
    ...
    function test_matchOrdersRouted_RevertsWithoutTrustedRouter() public {
        ...
        Order memory takerOrder = Order({user: taker, fromToken: address(usdc), toToken: address(eth), fromAmount: 1000 ether, toAmount: 10 ether, initialDepositAmount: 0, feeBps: 0, recipient: taker, expiration: uint48(block.timestamp + 1 days), uuid: 30, routeHash: bytes32(0)});
        Order memory makerOrder = Order({user: maker1, fromToken: address(eth), toToken: address(usdc), fromAmount: 10 ether, toAmount: 1000 ether, initialDepositAmount: 0, feeBps: 0, recipient: maker1, expiration: uint48(block.timestamp + 1 days), uuid: 31, routeHash: bytes32(0)});
    ...
    function test_matchOrdersRouted_InvalidSignature() public {
        ...
        Order memory takerOrder = Order({user: taker, fromToken: address(usdc), toToken: address(eth), fromAmount: 1000 ether, toAmount: 10 ether, initialDepositAmount: 0, feeBps: 0, recipient: taker, expiration: uint48(block.timestamp + 1 days), uuid: 32, routeHash: bytes32(0)});
        Order memory makerOrder = Order({user: maker1, fromToken: address(eth), toToken: address(usdc), fromAmount: 10 ether, toAmount: 1000 ether, initialDepositAmount: 0, feeBps: 0, recipient: maker1, expiration: uint48(block.timestamp + 1 days), uuid: 33, routeHash: bytes32(0)});
    ...
    function test_executeRoute_VaultPull_WalletReturn() public {
        ...
        Order memory makerOrder = Order({user: maker1, fromToken: address(eth), toToken: address(usdc), fromAmount: 10 ether, toAmount: 1000 ether, initialDepositAmount: 0, feeBps: 0, recipient: maker1, expiration: uint48(block.timestamp + 1 days), uuid: 101, routeHash: bytes32(0)});
    ...
    function test_executeRoute_VaultPull_VaultReturn() public {
        ...
        Order memory makerOrder = Order({user: maker1, fromToken: address(eth), toToken: address(usdc), fromAmount: 10 ether, toAmount: 1000 ether, initialDepositAmount: 0, feeBps: 0, recipient: maker1, expiration: uint48(block.timestamp + 1 days), uuid: 201, routeHash: bytes32(0)});
    ...
    function test_executeRoute_WalletPull_WalletReturn() public {
        ...
        Order memory makerOrder = Order({user: maker1, fromToken: address(eth), toToken: address(usdc), fromAmount: 10 ether, toAmount: 1000 ether, initialDepositAmount: 0, feeBps: 0, recipient: maker1, expiration: uint48(block.timestamp + 1 days), uuid: 301, routeHash: bytes32(0)});
    ...
    function test_executeRoute_WalletPull_VaultReturn() public {
        ...
        Order memory makerOrder = Order({user: maker1, fromToken: address(eth), toToken: address(usdc), fromAmount: 10 ether, toAmount: 1000 ether, initialDepositAmount: 0, feeBps: 0, recipient: maker1, expiration: uint48(block.timestamp + 1 days), uuid: 401, routeHash: bytes32(0)});
    ...
    function test_executeRoute_WalletPull_ThirdPartyReturn() public {
        ...
        Order memory makerOrder = Order({user: maker1, fromToken: address(eth), toToken: address(usdc), fromAmount: 10 ether, toAmount: 1000 ether, initialDepositAmount: 0, feeBps: 0, recipient: maker1, expiration: uint48(block.timestamp + 1 days), uuid: 501, routeHash: bytes32(0)});
