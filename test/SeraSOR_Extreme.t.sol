 ...
 *      - ROU-1 dust fix verification (single-leg, multi-leg, all slippage configs)
...
contract SeraSOR_Extreme_Test is TestHelper {
    ...
    // ========================================================================
    // 1. ROU-1 FIX VERIFICATION — SINGLE LEG WITH SPREAD
    // ========================================================================

    /// @notice Verify ROU-1 fix: no dust when 25% maker / 25% taker / 50% protocol
    function test_NoDust_SingleLeg_MixedShares() public {
        ...
        // ROU-1 fix: no tokens should remain in Sera
    ...
    // ========================================================================
    // 2. MULTI-LEG DUST ACCUMULATION (was the main ROU-1 risk)
    // ========================================================================
    ...
    function test_NoDust_ThreeLegRoute_SpreadEveryLeg() public {
        ...
        // ROU-1 fix: NO dust should remain in Sera for ANY token
