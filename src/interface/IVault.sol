...
interface IVault is IAccessControl {
     ...
     * @dev Measures surplus between actual balance and tracked balance, credits verified amount.
     * @param user The user to credit
     * @param token The token address
     * @param expectedAmount The expected amount (used for minimum check)
     */
